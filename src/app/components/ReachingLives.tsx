...
const ReachingLives = () => {
    return (
        <div className='bg-orange-gradient text-white  relative'>
            <div className='pt-10 pb-28 md:py-32  px-10 md:px-20  flex gap-4 flex-col'>
                <p className='font-medium  w-[75%] text-2xl md:text-7xl'>
            ...
            <div className="relative">
                <div className="bg-white shadow-lg rounded-xl w-3/4 px-10 md:px-28 py-5 md:py-10 z-10 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
