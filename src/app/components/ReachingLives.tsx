...
const ReachingLives = () => {
    return (
    <div className='bg-orange-gradient text-white relative h-[600px] md:h-1/2' id='reaching-lives'>
            <div className='py-32 md:py-32  px-10 md:px-20  flex gap-4 flex-col'>
                <p className='font-medium md:w-4/5 lg:text-6xl'>
            ...
            <div className="relative">
                <div className="bg-white shadow-lg text-center md:text-left rounded-xl w-3/4 px-10 md:px-28 py-5 md:py-10 z-10 absolute top-20 left-1/2 md:top-10 lg:top-20 xl:top-1/2 transform -translate-x-1/2 -translate-y-1/2">
                    <h2 className="font-bold italic lg:text-xl text-black">Reaching Lives</h2>
                        ...
                        {statistics.map(({ name, value }) => {
                            return (
                                <li key={name} className="flex flex-col h-fit w-40">
                                    <span className='text-3xl md:text-4xl lg:text-7xl font-bold'>
                                        <CountUp
                                            end={value}
                                            duration={5}
