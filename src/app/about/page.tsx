...
const WhoWeArePage = () => {
    return (
        <>
            <Header />
            <div className='relative w-full bg-[url("/who-we-are-hero-bg.png")] bg-no-repeat bg-cover bg-[25%_10%] py-48'>
            ...
            <div className='w-1/3 py-20 mx-auto my-5 flex flex-col gap-10'>
                <section className='flex flex-col gap-5'>
                    <span>WHO WE ARE</span>
                    <h2 className='italic text-4xl'>We are more than a non-profit organization, we are a <span className='text-orange-primary'>movement for change</span></h2>
                    <p>
            ...
            <section className='bg-orange-gradient text-white py-20'>
                <div className='flex w-2/3 items-center justify-center mx-auto gap-5'>
                    <div className='flex flex-col'>
                        <span>OUR MISSION IS SIMPLE</span>
                        <p className='font-bold text-4xl'>Every child deserves the chance to live, learn, play, and grow in a safe, healthy, and inspiring environment.</p>
                    </div>
                    <RoundedImageCard
                ...
                <div className='flex w-2/3 items-center justify-center mx-auto gap-5'>
                    ...
                    <div className='flex flex-col justify-items-center mx-auto'>
                        <p className='text-3xl font-bold'>We’re committed to the UN Sustainable Development Goals</p>
                        <ul>
            ...
            <section className='bg-blue-gradient h-96 text-white px-48 py-96 text-center mt-20'>
                <p className='text-6xl w-4/5 mx-auto'>We&apos;re creating a ripple effect that&apos;s changing families, communities, and futures.</p>
                <Button asChild className='bg-orange-dark hover:bg-orange-primary m-10'>
